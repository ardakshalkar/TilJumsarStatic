...
<h1 class="p-1 md:p-5 text-2xl font-bold font-['Inter'] text-left md:text-center">Бейне сабақ:  {{ $page->title }}</h1>
<div class="flex flex-col">
    ...
    <div class="w-full md:m-5">
        <div class="flex flex-col md:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a href="{{ $texts[$page->textId]->getUrl() }}/index.html" class="underline w-full md:w-auto text-2xl hover:font-bold bg-gray-100 px-4 py-2 rounded-lg"><span>📜</span><span class="">Мәтін</span></a>
            <a href="{{ $songs[$page->songId]->getUrl() }}/index.html" class="underline w-full md:w-auto text-2xl hover:font-bold bg-gray-100 px-4 py-2 rounded-lg"><span>🎶</span><span class="">Караоке</span></a>
            <a href="{{ $videos[$page->videoId]->getUrl() }}/index.html" class="underline w-full md:w-auto text-2xl hover:font-bold bg-gray-100 px-4 py-2 rounded-lg"><span>📹</span><span class="">Бейне жазба</span></a> 
        </div>
    </div>
</div>
@endsection
